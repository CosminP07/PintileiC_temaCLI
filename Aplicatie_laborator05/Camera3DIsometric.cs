...
namespace ConsoleApp3
{
    class Camera3DIsometric
    {
        ...
        {
            eye = new Vector3(50, 50, 15);   // Poziția camerei mai aproape de cub
            target = new Vector3(0, 25, 0);  // Punctul de interes este cubul
            up_vector = new Vector3(0, 1, 0);  // Direcția "up"
        }
